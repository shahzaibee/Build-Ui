...
const Portion = () => {
  return (
    <div className="md:h-[90vh] h-[115vh] w-full mt-5">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center px-14 mt-10">
        <div className="">
          <Image
            src={LeftImage}
            alt=""
            ...
            width={800}
            height={800}
            className="w-[550px] h-[350px] object-cover object-top rounded-md"
          />
          <div>
